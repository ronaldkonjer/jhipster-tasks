package info.sliceoflife.repository;

import info.sliceoflife.TasksApp;
import info.sliceoflife.config.Constants;
import info.sliceoflife.config.audit.AuditEventConverter;
import info.sliceoflife.domain.PersistentAuditEvent;
...
import static info.sliceoflife.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
